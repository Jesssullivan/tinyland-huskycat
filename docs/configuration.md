...
Git hook validation runs:
1. Staged file validation
2. Auto-fix when requested (SAFE confidence only)
3. Fast toolchain (binary or container based on availability)
4. Repository read-only mounting (container mode)
