...
⚠️ **Build-from-source only** - No Alpine APK package, requires full compiler build
...
**Answer**: ⚠️ **BUILD FROM SOURCE ONLY** - No APK package available
...
| **Container size** | ⚠️ 500MB-1.5GB+ | **CONCERN** |
